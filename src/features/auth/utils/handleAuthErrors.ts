...
export default function handleAuthErrors(error: AuthError) {
  switch (error.code) {
    case "anonymous_provider_disabled":
      return toast.error(
        "Anonymous sign-ins are not allowed. Please use a different sign-in method.",
      );
    case "bad_json":
    ...
    case "otp_expired":
      return toast.error("The OTP has expired. Please request a new one.");
    ...
    case "signup_disabled":
      return toast.error(
        "Sign-ups are currently disabled. Please contact support for more information.",
      );
    case "user_banned":
      return toast.error(
        "Your account has been temporarily banned. Please contact support for assistance.",
      );
    ...
    case "weak_password":
      return toast.error(
        "Your password does not meet the strength requirements. Please use a stronger password.",
      );
    default:
      return toast.error(
        `[Auth Api Error] An unexpected error occurred. Please contact support if the issue persists.`,
      );
  }
}
