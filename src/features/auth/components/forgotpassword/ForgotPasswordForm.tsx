...
import { ForgotPasswordFormDataSchema } from "@/features/auth/types/forgotpassword";
import useMultiStepForm from "@/hooks/useMultiStepForm";
import { useEffect } from "react";

export default function ForgotPasswordFrom() {
  const initialFormData: ForgotPasswordFormDataSchema = {
    email: "",
    verificationPin: "",
    password: "",
    confirmPassword: "",
  ...
  const multiStepForm =
    useMultiStepForm<ForgotPasswordFormDataSchema>(initialFormData);
